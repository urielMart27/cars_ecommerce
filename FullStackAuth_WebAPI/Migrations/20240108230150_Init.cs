        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnertId = table.Column<string>(type: "varchar(255)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cars_AspNetUsers_OwnertId",
                        column: x => x.OwnertId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    BuyertId = table.Column<string>(type: "varchar(255)", nullable: true),
                    SellerId = table.Column<string>(type: "varchar(255)", nullable: true),
                    SoldCarId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sales_AspNetUsers_BuyertId",
                        column: x => x.BuyertId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Service_Cars_AssociatedCarId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_SoldCarId",
                table: "Sales",
                column: "SoldCarId");

            migrationBuilder.CreateIndex(
                name: "IX_Service_AssociatedCarId",
                table: "Service",
